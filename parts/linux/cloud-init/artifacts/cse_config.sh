...
ensureKubelet() {
    ...
    # If aks-local-dns systemd service needs to be enabled, then Kubelet's --cluster-dns flag is set AKS_LOCAL_DNS_CLUSTER_LISTENER_IP address.

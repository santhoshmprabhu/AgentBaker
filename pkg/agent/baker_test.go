				...
				AgentPoolProfiles: []*datamodel.AgentPoolProfile{
					{
						...
						AKSLocalDNSProfileWithSortedDomains: &datamodel.AKSLocalDNSProfileWithSortedDomains{
							AKSLocalDNSProfile: datamodel.AKSLocalDNSProfile{
								ServiceState:    "Enabled",
								CPULimit:        2,
								MemoryLimitInMB: 128,
								CoreDNSImageUrl: "mcr.microsoft.com/oss/kubernetes/coredns:v1.9.4",
								VnetDNSOverrides: map[string]datamodel.AKSLocalDNSOverride{
									".": {
										LogLevel:               "errors",
										ForceTCP:               false,
								...
								KubeDNSOverrides: map[string]datamodel.AKSLocalDNSOverride{
									".": {
										LogLevel:               "errors",
										ForceTCP:               true,
										ForwardPolicy:          "sequential",
								...
								DefaultUpstreamDNSServerIP: "169.63.129.16",
							},
